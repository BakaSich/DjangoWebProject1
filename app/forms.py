...
class AnketaForm(forms.Form):
 name = forms.CharField(label='Имя', min_length=2, max_length=100, required=True)
 ...
 paymentMethod = forms.ChoiceField(label='Способ оплаты', choices=((1, 'Картой на сайте'), (2, 'Наличными при получении')), required=True)
